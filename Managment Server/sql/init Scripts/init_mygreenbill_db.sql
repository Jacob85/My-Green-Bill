...
START TRANSACTION;
USE `mygreenbilldb`;
INSERT INTO `mygreenbilldb`.`mail_template` (`id`, `name`, `description`, `context`, `path_to_file`, `create_date`) VALUES (1, 'Welcome', 'Welcome to any new user', 'Thanks for joining My Green Bill ', 'path/to/file.png', '2013-08-01');
